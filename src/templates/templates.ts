...
type NewInvitation = {
    token: string,invitations: number,start: string,finish: string,cost: number
}

export const newInvitationTemplate = (newInvitation: NewInvitation) => {
